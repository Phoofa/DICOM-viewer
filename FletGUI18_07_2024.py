...
class DICOMViewer:
    ...
    def create_ui(self):
        ...
        self.rotate_button_clockwise = ft.ElevatedButton("Rotate Clockwise", on_click=lambda _: self.rotate_image(clockwise=True))
        self.rotate_button_counterclockwise = ft.ElevatedButton("Rotate Counterclockwise", on_click=lambda _: self.rotate_image(clockwise=False))
    ...
    def browse_directory(self, e):
        ...
        selected_directory = filedialog.askdirectory(parent=root)
        root.destroy()
    ...
    def browse_dcm_file(self, e):
        ...
        root.withdraw()
        root.attributes('-topmost', True)  # Make sure the dialog appears in front
        selected_file = filedialog.askopenfilename(parent=root, filetypes=[("DICOM files", "*.dcm")])
        root.destroy()
    ...
    def display_image(self, image_array):
        ...
        self.image_display.src_base64 = base64.b64encode(buf.read()).decode('utf-8')
        self.page.update()
